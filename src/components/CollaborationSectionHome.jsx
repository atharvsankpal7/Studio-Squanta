...
const CollaborationSectionHome = () => {
    ...
    return (
        <div className="
            w-full max-w-[90rem] h-auto lg:h-[58rem] bg-white mx-auto 
            flex flex-col items-center px-[0.25rem]
            pt-[2rem] sm:pt-[3rem] md:pt-[4rem] lg:pt-[6rem] xl:pt-[9rem]
            my-[1rem] sm:my-[2rem] md:my-[3rem] lg:my-[4rem] xl:my-0
        ">
            {/* Heading */}
            <h2
                className="
                    ...
                    lg:text-[6rem] lg:max-w-[60rem] lg:mb-12
                    xl:text-[8rem] xl:max-w-[85.3125rem] xl:h-[29.25rem] xl:mb-0
