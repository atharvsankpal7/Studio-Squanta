  ...
  return (
    <div className="bg-black text-white font-alan-sans">
      ...
      >
        ...
        w-[18rem] h-[3rem] p-[0.375rem] gap-[0.75rem] rounded-[1.5rem] my-6
        sm:w-[24rem] sm:h-[3.5rem] sm:p-[0.5rem] sm:gap-[0.875rem] sm:rounded-[2rem] sm:my-8
        md:w-[32rem] md:h-[4rem] md:p-[0.625rem] md:gap-[1rem] md:rounded-[2.5rem] md:my-10
        lg:w-[50rem] lg:h-[5rem] lg:p-[0.625rem] lg:gap-[1.125rem] lg:rounded-[3rem] lg:my-12
        xl:w-[82.375rem] xl:h-[6.3125rem] xl:p-[0.625rem] xl:gap-[1.25rem] xl:rounded-[3.5625rem] xl:my-14
        ...
        >
          ...
          <span
            className="
          text-white  font-semibold leading-normal whitespace-nowrap
          text-[1rem] w-[8rem]
