  ...
  return (
    <div className="bg-black overflow-hidden">
      ...
      >
        ...
        <p className="mx-auto text-center w-[74.75rem] text-[6.0425rem] font-alan-sans leading-tight">We create with passion, purpose, and play — because work should feel like something you love, not just something you do.</p>
